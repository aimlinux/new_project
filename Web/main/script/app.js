        ...
        preview.onload = function () {
            return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, generateMemory()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
...
function generateMemory() {
    return __awaiter(this, void 0, void 0, function () {
        var results, label, text, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!classifier) {
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error("ml5 error:", error_1);
                    memoryDiv.innerText = "エラーが発生しました: " + error_1.message;
                    return [3 /*break*/, 4];
...
function createMemoryFromLabel(label) {
